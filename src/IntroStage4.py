...
class IntroStage4:
	...
	def __init__(self, master, prev_sc, main_bg):
		...
		self.title = tkinter.Label(master, bg='white',\
									 fg = 'black', text='FASE 4', font=Font(family='Helvetica', size=30, weight='bold'))
	...
	def start_button_click(self):
		...
		self.global_points.set(int(self.prev_sc.points.get()))
		self.points.set(0)
